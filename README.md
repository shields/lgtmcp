...
Google Gemini 3.8 Flash. LGTMCP reviews your code changes and either commits them
...
Gemini 3.8 Flash, which is priced lower per token. You should decide whether
that is slow and expensive or fast and cheap.

## Features

- **AI Code Review**: Leverages Google Gemini 3.8 Flash for intelligent code analysis
...
review), or `none` to leave the model's own default in place. Gemini 3.8 Flash
...
primary model. It is disabled by default (`none`); Gemini 3.8 Flash is generally
...
3. **AI review**: Sends diff to Gemini 3.8 Flash for analysis
